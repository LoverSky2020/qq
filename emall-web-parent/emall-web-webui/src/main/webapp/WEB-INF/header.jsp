...
<div id="searchss">
	<div class="search">
		<div class="logo">
			<a href="index"><img src="static/index/img/logo.jpg"/></a>
		</div>
		...
		<div class="sera_cart">
			<a href="cart/get"><p><i class="iconfont icon-gouwuche5"></i>我的购物车</p></a>
		 ...
		 <div class="sear_fir">
		 	<c:if test="${sessionScope.user==null}">
				<div class="sinup">
					<a href="user/login/page">登录</a>
					<a>/</a>
					<a href="user/register/page">注册</a>
				</div>
				<div class="sinup">
					<a target="_blank" href="http://localhost:8080/emall/admin/login/page">后台管理</a>
				</div>
			</c:if>
			
			<c:if test="${sessionScope.user!=null}">
				<div class="sigin">
	     			<span class="wel" id="wel">Hi,${sessionScope.user.name}</span>
	     		</div>
				<div class="my">
					<a>个人中心</a>
...
<div id="navall">
	<div id="nav">
		...
		<div class="proclass">
			...
			<div class="prolist" style="display:none;">
				...
				<c:forEach items="${typeList}" var="type">
					<div class="list">
						<dl>
							<a href="goods/sort/${type.id}"><dt>${type.name}</dt></a>
						</dl>
					</div>
				</c:forEach>
		...
		<!--导航-->
		<ul id="inav">
			<li <c:if test="${flag==1}">class="active"</c:if>><a href="index/display">商城首页</a></li>
			<li <c:if test="${flag==2}">class="active"</c:if>><a href="goods/today">今日推荐</a></li>
			<li <c:if test="${flag==3}">class="active"</c:if>><a href="goods/hot">热销排行</a></li>
			<li <c:if test="${flag==4}">class="active"</c:if>><a href="goods/new">新品上市</a></li>
		</ul>
...
$(document).on("click", ".addcart", function(){
	...
	$.post("cart/add", {goodId:goodId}, function(data){
		layer.close(index);
