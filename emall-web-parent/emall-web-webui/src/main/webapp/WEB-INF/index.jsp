		...
		<div class="m_content m_today_box">
			<div id="m_today">
				<div class="m-hot-tit clearfix">
					...
					<a href="goods/today"><div class="m-hot-tit-right"><span>更多推荐 ></span></div></a>
				</div>
		...
		<div class="m_content mdd-top">
			<div id="m_hot">
				<div class="m-hot-tit clearfix">
					...
					<a href="goods/hot"><div class="m-hot-tit-right"><span>更多热销 ></span></div></a>
				</div>
		...
		<c:forEach items="${dataList}" var="data">
			<div class="main Louti vegetable">
				<div class="m-hot-tit clearfix">
					...
					<a href="goods/sort/${data.id}"><div class="m-hot-tit-right">查看更多 ></div></a>
				</div>
				<div class="main-box">
...
<script src="static/index/js/jquery.fly.min.js" type="text/javascript"></script>
<script src="static/index/js/jquery.flexslider.min.js" type="text/javascript"></script>
