...
<body>
	...
	<link rel="stylesheet" type="text/css" href="static/idnex/css/public.css">
	<link rel="stylesheet" type="text/css" href="static/index/css/common.css">
	<link rel="stylesheet" type="text/css" href="static/index/css/details.css">
	...
	<div id="main" class="main">
		...
		<div id="mnav" style="background: #f6f6f6;border: 1px solid #eee;">
			<a href="goods/sort/${good.type.id}"><span style="color:#ff852b;">${good.type.name}</span></a>
