...
public interface GoodsMapper {
    ...
    void insertGoodsRecommend(@Param("goodId") Integer goodId,@Param("type") Integer type);

    void deleteGoodsRecommend(@Param("goodId") Integer goodId, @Param("type") Integer type);
}