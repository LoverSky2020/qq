...
<body style="background:#fbf8ef;background-size:100%;">
	...
	<div class="container">
		...
		<c:if test="${requestScope.exception.message !=null}"><div class="alert alert-danger text-center">${requestScope.exception.message }</div></c:if>
		<form class="form-horizontal"action="admin/login" method="post" style="margin-top:15%;" >
